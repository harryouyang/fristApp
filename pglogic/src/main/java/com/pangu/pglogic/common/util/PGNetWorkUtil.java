...
public class PGNetWorkUtil {
    ...
    public static boolean printNetworkInfo(Context context) {
        ...
        if (connectivity != null) {
            ...
            PGLogUtil.i(TAG, "-------------$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$-------------");
            PGLogUtil.i(TAG, "getActiveNetworkInfo: " + in);
            NetworkInfo[] info = connectivity.getAllNetworkInfo();
            if (info != null) {
                for (int i = 0; i < info.length; i++) {
                    PGLogUtil.i(TAG, "NetworkInfo[" + i + "]isAvailable : " + info[i].isAvailable());
                    PGLogUtil.i(TAG, "NetworkInfo[" + i + "]isConnected : " + info[i].isConnected());
                    PGLogUtil.i(TAG, "NetworkInfo[" + i + "]isConnectedOrConnecting : " + info[i].isConnectedOrConnecting());
                    PGLogUtil.i(TAG, "NetworkInfo[" + i + "]: " + info[i]);
                }
                PGLogUtil.i(TAG, "\n");
            } else {
                PGLogUtil.i(TAG, "getAllNetworkInfo is null");
            }
        }
        return false;
    }
