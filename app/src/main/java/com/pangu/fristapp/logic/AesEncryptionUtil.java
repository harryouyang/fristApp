...
import com.pangu.pglogic.common.util.PGBytesUtil;
...
public class AesEncryptionUtil {
    ...
    public static String encrypt(String content, String password, String iv) {
        ...
        String result = PGBytesUtil.bytesToHexString(data);
        return result;
    }
    ...
    public static String decrypt(String content, String password, String iv) {
        byte[] data = null;
        try {
            data = PGBytesUtil.hexStringToBytes(content);
        } catch (Exception e) {
            e.printStackTrace();
        }
